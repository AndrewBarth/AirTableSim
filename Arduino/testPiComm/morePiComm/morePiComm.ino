...
void loop() {
   ...
   if (Serial.available() > 0) {
    ...
    //messageSize = read_serial_message(Serial, &incomingString, MAX_MESSAGE_SIZE);

    // Convert the string to character bits
    //char cmds[messageSize+1];
    //incomingString.toCharArray(cmds,messageSize+1);
