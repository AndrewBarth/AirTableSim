...
figure;
subplot(4,1,1);plot(thrusterCmds.Time,thrusterCmds.Data(:,1))
title('Thruster 1');xlabel('Time (sec)');ylabel('Command (--)')
subplot(4,1,2);plot(thrusterCmds.Time,thrusterCmds.Data(:,2))
title('Thruster 2');xlabel('Time (sec)');ylabel('Command (--)')
subplot(4,1,3);plot(thrusterCmds.Time,thrusterCmds.Data(:,3))
title('Thruster 3');xlabel('Time (sec)');ylabel('Command (--)')
subplot(4,1,4);plot(thrusterCmds.Time,thrusterCmds.Data(:,4))
title('Thruster 4');xlabel('Time (sec)');ylabel('Command (--)')

figure;
subplot(4,1,1);plot(thrusterCmds.Time,thrusterCmds.Data(:,5))
title('Thruster 5');xlabel('Time (sec)');ylabel('Command (--)')
subplot(4,1,2);plot(thrusterCmds.Time,thrusterCmds.Data(:,6))
title('Thruster 6');xlabel('Time (sec)');ylabel('Command (--)')
subplot(4,1,3);plot(thrusterCmds.Time,thrusterCmds.Data(:,7))
title('Thruster 7');xlabel('Time (sec)');ylabel('Command (--)')
subplot(4,1,4);plot(thrusterCmds.Time,thrusterCmds.Data(:,8))
title('Thruster 8');xlabel('Time (sec)');ylabel('Command (--)')
